"""Circle permisions clases"""

#dejango rest framework
...
class IsActiveCircleMember(BasePermission):
    """Allow access only to circle memebers
        ...
        Excpect that the views implementing this permission
        have a 'circle' attribute assigned.
    """
    def has_permission(self, request, view):
        """Verify user os an active member of the circle"""
        try:
...
class IsAdminOrMembershipOwner(BasePermission):
    ...
    """Allow access only to (Circle''admin) or users
